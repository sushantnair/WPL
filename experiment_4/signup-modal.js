...
function Redirect1(){
    window.location = "Student_Dashboard_KJSCE_CFAS.html";
}
const debouncedUserInput1 = debounce(Redirect1);
function Redirect2(){
    window.location = "Faculty_Dashboard_KJSCE_CFAS.html";
}
const debouncedUserInput2 = debounce(Redirect2);*/